...
export default async function Home() {
  ...
  return (
    <main className="relative bg-white">
      ...
      {/* Purpose Section */}
      <section className="relative py-48 bg-cover bg-center overflow-hidden" style={{ backgroundImage: `url("${content.purpose?.image || 'https://images.unsplash.com/photo-1544735716-392fe2489ffa?auto=format&fit=crop&w=1920&q=80'}")` }}>
